...
public class AES {
    ...
    public static String encrypt(String data, String password_text) throws Exception {
    ...
    public static String decrypt(String data, String password_text) throws Exception {
        SecretKeySpec key = generateKey(password_text);
        // Log.d("NIKHIL", "encrypt key:" + key.toString());
